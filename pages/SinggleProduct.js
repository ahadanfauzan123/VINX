...
function SinggleProduct({}) {
  ...
  return (
    <div className='bg-theme'>
      <Header/>
      <BuyModal/>
      <div className='flex flex-col space-y-6 items-center justify-center w-full max-w-[65rem] bg-themeSecondary pb-3 pt-3 mt-1 mx-auto'>
        ...
        {/* payment and buttons */}
        <div className='bg-cardTheme flex justify-between items-center max-w-4xl w-full py-6 px-7 rounded-[20px]'>
          {/* price */}
          <div>
        ...
        {/* product features */}
        <div className='flex flex-col space-y-4 bg-cardTheme w-full max-w-4xl px-5 py-6 rounded-[20px]'>
